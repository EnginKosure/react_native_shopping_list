...
import { StyleSheet, Text, View, SafeAreaView, Button, TextInput, TouchableOpacity, Dimensions, Keyboard, FlatList } from 'react-native'
...
const Second = ({ route, navigation }) => {
    ...
    const fetchCafes = (txt, ml) => {
        fetch(`https://api.yelp.com/v3/businesses/search?term=${meal}&location=${txt}`, config)
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={{ backgroundColor: '#00838F', flex: 1 }}>
                ...
                <View style={styles.Search_Box_View}>
                    ...
                    <TouchableOpacity style={styles.button_touch} onPress={() => fetchCafes(text, meal)}>
